			...
			$params = array(
				...
				'labels'                => apply_filters(
					...
					array(
						...
						'show_results'         => _x( 'Hiển thị kết quả', '[FRONTEND] Label for filter button, on mobile modal', 'yith-woocommerce-ajax-navigation' ),
						...
						'clear_all_selections' => _x( 'Xóa tất cả', '[FRONTEND] Label for clear selection link, that appears above filter after selection', 'yith-woocommerce-ajax-navigation' ),
					)
				),
			);
