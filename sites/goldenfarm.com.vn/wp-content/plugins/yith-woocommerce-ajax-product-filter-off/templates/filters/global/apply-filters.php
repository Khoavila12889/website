...
<button class="<?php echo esc_attr( $button_class ); ?>">
	<?php echo esc_html( apply_filters( 'yith_wcan_filter_button', _x( 'Áp dụng bộ lọc', '[FRONTEND] Filter button for preset shortcode', 'yith-woocommerce-ajax-navigation' ) ) ); ?>
</button>
