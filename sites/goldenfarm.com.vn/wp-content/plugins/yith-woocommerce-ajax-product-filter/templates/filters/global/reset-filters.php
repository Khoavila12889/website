...
<button class="<?php echo esc_attr( $button_class ); ?>">
	<?php echo esc_html( apply_filters( 'yith_wcan_filter_reset_button', _x( 'Xóa bộ lọc', '[FRONTEND] Reset button for preset shortcode', 'yith-woocommerce-ajax-navigation' ) ) ); ?>
</button>
