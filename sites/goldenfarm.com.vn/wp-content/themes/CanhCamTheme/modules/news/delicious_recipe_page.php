...
<section class="delicious-recipe-section section overflow-hidden">
	<div class="container">
		...
		?>
			<div class="delicious-recipe-list grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-10 lg:mt-15 xl:mt-18">
				<?php
		...
		<?php
			...
			echo '<delicious-recipe-list grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-10 lg:mt-15 xl:mt-18">';
			echo _e('Đang cập nhật công thức mới nhất!', 'canhcamtheme');
			echo '</div>';
		endif;
		wp_reset_postdata();
