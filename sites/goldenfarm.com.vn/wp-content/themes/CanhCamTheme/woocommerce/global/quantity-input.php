...
?>
<div class="info-item quantity hidden">
	<div class="label">
		<?php esc_html_e('Số lượng', 'woocommerce'); ?>
	</div>
	<div class="quantity-wrap">
		<span class="btn-spin minus"><i class="fa-regular fa-minus"></i></span>
		...
		<span class="btn-spin plus"><i class="fa-regular fa-plus"></i></span>
	</div>
</div>
